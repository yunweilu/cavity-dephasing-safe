...
import scipy as sci
class Hamiltonian:
    def __init__(self, phi_ex, Ej, Ec, original_dim, trunc_dim, omega_c1, omega_c2, N=1, beta=1, g=0.1*0.176839*2*np.pi):
        """
        ...
        g: coupling strength in angular units (rad·GHz), used directly as self.g.
        """
        ...
        self.g = g
        self.H, self.H_control, self.H_flux_drive = self.get_H()
    ...
    def SNAIL(self):
        ...
        return Hs, charge_op, flux_drive
    ...
    def get_H(self):
        ...
        Hs, charge_op, flux_drive = self.SNAIL()
        squid = [Hs, charge_op, flux_drive]
        ...
        H, H_control, H_flux_drive = self.composite_sys(squid, cavity, cavity2)
        return H, H_control, H_flux_drive

    def composite_sys(self, squid, cavity, cavity2):
        """Composes the full system Hamiltonian from subsystems."""
        Hs, charge_op, flux_drive = squid
        Hc, Vc = cavity
        Hc2, Vc2 = cavity2
        sdim = Hs.shape[0]
        cdim = Hc.shape[0]
    ...
    def dressed_basis(self):
        H, H_control, H_flux_drive = self.get_H()
